  ...
  <div class="register-box">
    ...
    <el-form ref='formRef' :model = 'form' style="min-height: 600px" class="register-form" :rules="rules">
      ...
      <el-form-item prop="email" class="register-input-email">
        <el-input type="text" :prefix-icon="Iphone" size="large" v-model="form.email" placeholder="请输入手机号"></el-input>
      </el-form-item>
      ...
      <el-form-item prop="code">
        ...
        <el-button type="info" :disabled="codeDisabled" class="verificationButton" @click="sendVerification" plain>向手机发送验证码</el-button>
      </el-form-item>
    ...
    <div class="line1"></div>
    <div class="line2"></div>
    <div class="emailRegister" @click="changeRegisterWay(1)">邮箱注册</div>
    <div class="mobileRegister" @click="changeRegisterWay(2)">手机号注册</div>
  </div>
</template>
<script setup>
import {Hide, Lock, Iphone, User, View} from "@element-plus/icons-vue";
